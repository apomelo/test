...
public class CodecUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        AudioFormat.Encoding encoding = AudioCodec.G729.getAudioFormat().getEncoding();
        CodecUtil codecUtil = new CodecUtil(encoding);
        String pcmFile = "D:\\data\\voice\\123456.wav";
        String encodeFile = "D:\\data\\voice\\123456_en.G729";
        String decoderFile = "D:\\data\\voice\\123456_de.raw";
...
//        byte[] decodeData = codecUtil.decode(FileUtils.readFileToByteArray(new File(encodeFile)));
//        FileUtils.writeByteArrayToFile(new File(decoderFile), decodeData);
    }
