...
//        encodeMulti();
    ...
    private static void encodeMulti() {
        ...
        for (int i = 0; i < max; i ++) {
            ...
            sb.append(RandomUtils.nextInt(2, 10)).append(RandomUtils.nextLong(999, 9999999999L)).append(RandomUtils.nextLong(999, 9999999999L));
    ...
    private static void encodeMulti2() {
        ...
        for (int i = 0; i < max; i ++) {
            StringBuilder sb = new StringBuilder();
            sb.append(RandomUtils.nextLong(999, 9999999999L)).append(RandomUtils.nextLong(999, 9999999999L)).append(RandomUtils.nextInt(2, 10));
            BigInteger bigInteger = new BigInteger(sb.toString());
            String s = bigInteger.toString(Character.MAX_RADIX);
            int length = s.length();
