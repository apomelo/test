...
public class AlgoDynamicProgramming {
    public static void main(String[] args) {
        ...
        log.info("HouseRobber: {}", new HouseRobber().rob(new int[] {2,1,1,5,1}));
        // [213] 打家劫舍 II
        log.info("HouseRobberII: {}", new HouseRobberII().rob(new int[] {2,3,2}));
        log.info("HouseRobberII: {}", new HouseRobberII().rob(new int[] {1,2,3,1}));
        log.info("HouseRobberII: {}", new HouseRobberII().rob(new int[] {1,2,3}));
    }
}
