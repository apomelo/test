...
import example.io.netty.task.IDriverTask;
...
public class QueueMonitor {
    ...
    static boolean open;
    private static Map<String, QueueMonitor.QueueCount> commandCountMap;
    ...
    public static void monitor(IDriverTask command, long startTime, int totalTime) {
